...
*   [time](https://courses.newschool.edu/courses/PUFY1040/)
    ...
    *   when are we in history?
        
    *   time doesn’t exist, yet it controls us anyways
...
*   birth of the computer
    ...
    *   [ada lovelace](https://en.wikipedia.org/wiki/Ada_Lovelace) (1815-1852) and charles babbage ([analytical engine](https://en.wikipedia.org/wiki/Analytical_Engine)) 
        ...
        *   [state](https://en.wikipedia.org/wiki/State_(computer_science)) & [finite state machine](https://en.wikipedia.org/wiki/Finite-state_machine)
            
    *   analog => digital: parts of computer
        
        *   storage
            
            *   [mechanical calculators](https://en.wikipedia.org/wiki/Mechanical_calculator) \[[1](https://x.com/BBCWorld/status/1991332462681567391?s=20)\]
                
            *   [tape storage](https://en.wikipedia.org/wiki/Magnetic-tape_data_storage) (VHS/cassette)
...
*   product development 
    ...
    *   ideation
        ...
        *   sketchpad
            ...
            *   apply drawing conventions (architecture?)
...
*   software 
    ...
    *   [evolution](https://en.wikipedia.org/wiki/History_of_programming_languages) of programming languages 
        ...
        *   javascript, ruby, python, haskell
            ...
            *   internet age: ports, connections
...
*   [occult](https://youtu.be/KuifawQ3xtM?si=1zZggGSiei8rYAtQ) sciences
    ...
    *   light
        ...
        *   light [facts](https://podcasts.apple.com/us/podcast/tetragrammaton-with-rick-rubin/id1671669052?i=1000727156469)
...
*   arduino tech
    ...
    *   [arduino](https://docs.arduino.cc/language-reference/) programming language
...
*   small project using:
    ...
    *   breakout board or arduino board
        
    *   resistor
        
*   safety
    
    *   youtube at least 2 safety videos on each new piece of equipment OR
        
    *   receive first-hand instruction from professional/woodshop
...
*   minimum-viable product (MVP)
    ...
    *   separate core features from add-ons (push to v2)
        
    *   apply iterative approach/versioning
...
*   eye towards marketing
    
    *   document any development highlights
        
    *   document product at rest and “functioning”
        
    *   discuss channels for communicating/advertising
        
        *   social
            
        *   etsy marketplace/shopify store
            
        *   ad tags/paid platforms
            
        *   word of mouth, showcasing, exhibitions
